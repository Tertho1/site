...
// Data - prioritized real projects (non-forked, non-scrap) — plain-language what it does
const projects = [
  {
    id: 'plagioscale',
    title: 'PlagioScale',
    subtitle: 'Spot copied & AI-written work',
    desc: 'Upload an essay or report and get a clear report of copied parts and AI-generated writing, with highlighted matches and a simple score. Built for teachers and teams to check work quickly and keep an audit trail.',
    ...
    stats: 'For teachers & teams • Clear reports',
    category: 'AI/ML',
  },
  {
    id: 'cvinsight',
    title: 'CVInsight',
    subtitle: 'Resume ↔ Job fit score 0–100',
    desc: 'Paste your resume and a job description — get an instant 0–100 fit score and tips on what to improve. Trained on 6,241 real examples and live as a web app.',
    stack: ['Python','NLP','XGBoost','Streamlit'],
    highlight: true,
    image: 'CV',
    links: { github: 'https://github.com/Tertho1/cvinsight', demo: 'https://cvinsight-io.streamlit.app' },
    stats: '6,241 examples • Live web app',
    category: 'AI/ML',
  },
  {
    id: 'truemedic',
    title: 'TrueMedic',
    subtitle: 'Verify a doctor in seconds',
    desc: 'Search a doctor by ID and see a verified profile instantly — helps patients check credentials and clinics manage trusted records with secure login.',
    stack: ['Supabase','Dart','Python','FastAPI','PostgreSQL'],
    highlight: false,
    image: 'TM',
    links: { github: 'https://github.com/Tertho1/TrueMedic', demo: null },
    stats: 'For patients & clinics • Verified profiles',
    category: 'Web/App',
  },
  {
    id: 'tube',
    title: 'TubeGrabber',
    subtitle: 'Save YouTube for offline learning',
    desc: 'A simple desktop app to search YouTube and save videos, audio or full playlists — pick quality, track progress, and keep everything organized for study.',
    stack: ['Python','Tkinter','yt-dlp','FFmpeg','Threading'],
    highlight: false,
    image: 'TG',
    links: { github: 'https://github.com/Tertho1', demo: null },
    stats: 'Desktop app • Search + download',
    category: 'Python',
  },
  {
    id: 'mentalqlm',
    title: 'MentalQLM',
    subtitle: 'Understand mental-wellbeing signals',
    desc: 'A lightweight AI that reads text and flags signs of stress or low mood to help with early triage — research-focused and not a medical diagnosis, built to be efficient on smaller models.',
    stack: ['Python','LLM','LoRA','LLaMA-Factory','Torch'],
    highlight: true,
    image: 'MQ',
    links: { github: 'https://github.com/Tertho1', demo: null },
    stats: 'Research • Efficient & focused',
    category: 'LLM',
  },
  {
    id: 'pdfsummarizer',
    title: 'PDF Summarizer',
    subtitle: 'Turn long PDFs into short summaries',
    desc: 'Drop any PDF — even scanned photos — and get a concise summary of the key points. It reads the text automatically and shortens long reports for you.',
    stack: ['Python','PyMuPDF','Tesseract','Transformers','BART'],
    highlight: true,
    image: 'PDF',
    links: { github: 'https://github.com/Tertho1/pdf-summarizer', demo: null },
    stats: 'Any PDF • Scanned OK • Short summary',
    category: 'AI/Python',
  },
  {
    id: 'iotsmarthome',
    title: 'IoT Smart Home',
    subtitle: 'Control home from your phone',
    desc: 'Switch lights, fans and sensors from a phone dashboard. The ESP32 hardware connects over Wi-Fi with easy setup and one-tap wireless updates — no rewiring needed.',
    stack: ['ESP32','Arduino','PlatformIO','OTA','IoT'],
    highlight: false,
    image: 'IoT',
    links: { github: 'https://github.com/Tertho1', demo: null },
    stats: 'Phone dashboard • Wireless updates',
    category: 'IoT',
  },
  {
    id: 'convertkit',
    title: 'ConvertKit',
    subtitle: 'Turn slides into PDFs instantly',
    desc: 'Upload PowerPoint files and get PDFs back right away — single file as PDF, many files as a ZIP. Works online as a fast, reliable converter.',
    stack: ['Python','FastAPI','LibreOffice','Docker'],
    highlight: false,
    image: 'CK',
    links: { github: 'https://github.com/Tertho1', demo: null },
    stats: 'Online • One-click PPTX → PDF',
    category: 'Backend',
  },
]
          ...
          <div className="min-w-0">
            ...
            <div className="mt-8 sm:mt-10 grid grid-cols-3 divide-x divide-zinc-200 dark:divide-zinc-800 border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden bg-white dark:bg-zinc-900">
              {[
                ...
                {k:'12+', v:'Projects', sub:'Shipped end-to-end'},
              ].map(s=>(
